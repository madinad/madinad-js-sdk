...
var madinadSDK = {
    ...
    communicate: function(){
        ...
        madinadSDK.interv = setInterval(function(){ madinadSDK.jsonp(url); }, madinadSDK.properties.polling_interval);
    },
    ...
    add_offer: function(offer_inbox,num,title,subtitle,logo,index_url,cid){
        ...
        if (!campaigns_cookie[cid]) {
            ...
            new_offer.onclick = function(){madinadSDK.read_offer(cid);madinadSDK.create_modal(url); this.style.borderLeft=""};
        } else {
    ...
    create_modal: function(url, campaign_type){
        ...
        modal.innerHTML = '<div id="close_modal" style="min-width: 10%; min-height: 10%; z-index:1000; position:absolute; top:0; right:0; cursor:pointer;">' +
            ...
            '</div>' +
            '<div style="position:relative; height:100%; margin-left:auto; margin-right:auto; overflow:auto; -webkit-overflow-scrolling:touch;"><iframe id="modal_iframe" src="'+ url_ref +'" style="border: none; border-radius: 5px; overflow:auto; -webkit-overflow-scrolling:touch; display: block; margin-left: auto; margin-right: auto;" width="100%" height="100%"></iframe></div>';
